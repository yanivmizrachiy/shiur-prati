...
check('angle labels are placed by interior bisector', fn.includes('labelPts.push(lp)') && fn.includes('scoreTriangleLayout'));
check('best layout selected from 36 candidates', fn.includes('seed<36') && fn.includes('best.score'));
