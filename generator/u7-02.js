...
generators['U7-05']=function(){
  ...
  const svg='<svg class="engine-svg" viewBox="0 0 292 205" xmlns="http://www.w3.org/2000/svg"><rect x="14" y="12" width="264" height="178" rx="14" fill="#eff6ff" stroke="#2563eb" stroke-width="1.8"/><text x="146" y="32" font-size="12" font-weight="900" text-anchor="middle" fill="#334155">דיאגרמת עוגה — '+s.title+'</text><circle cx="86" cy="92" r="52" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><path d="M86 92 L86 40 A52 52 0 0 1 116 134 Z" fill="#93c5fd" stroke="#2563eb" stroke-width="1.5"/>'+legend+'<text x="146" y="181" font-size="11" font-weight="800" text-anchor="middle" fill="#334155">דיאגרמת עוגה ושכיחות יחסית</text></svg>';
