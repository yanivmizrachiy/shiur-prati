...
generators['G7-06']=function(){
  const svg='<svg class="engine-svg" viewBox="0 0 260 176" xmlns="http://www.w3.org/2000/svg"><rect x="12" y="10" width="236" height="145" rx="14" fill="#f0fdf4" stroke="#166534" stroke-width="1.8"/><rect x="50" y="45" width="150" height="90" fill="#bbf7d0" stroke="#166534" stroke-width="2"/><rect x="130" y="45" width="70" height="38" fill="#ffffff" stroke="#dc2626" stroke-width="2" stroke-dasharray="4 3"/><text x="125" y="150" text-anchor="middle" font-size="12" font-weight="800">15 ס״מ</text><text x="30" y="95" font-size="12" font-weight="800">9 ס״מ</text><text x="165" y="40" text-anchor="middle" font-size="11" font-weight="800" fill="#dc2626">7 ס״מ</text><text x="205" y="68" font-size="11" font-weight="800" fill="#dc2626">4 ס״מ</text><text x="130" y="170" text-anchor="middle" font-size="11" font-weight="800">שטח מלבן פחות מלבן חסר</text></svg>';
