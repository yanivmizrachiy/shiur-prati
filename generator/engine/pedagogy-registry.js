...
(function () {
  ...
  topic('G7-02-ENGINE', {
    topicName: 'שטחי צורות שטוחות', skill: 'שטח משולש, מקבילית, טרפז, גובה חסר',
    learningGoal: 'התלמיד יחשב שטחי צורות שטוחות וימצא גובה חסר',
  ...
  // ───────────────────────── FALLBACK TOPICS (still generic renderer) ─────────
  function fb(id, topicName, skill, learningGoal, teacherPurpose, misconception, followUps, families) {
    topic(id, {
      topicName, skill, learningGoal, teacherPurpose,
      misconceptions: [misconception], followUpIdeas: followUps,
      engineSupport: 'fallback', status: 'fallback', families
    });
  }
  fb('N7-08', 'ציר מספרים והשוואת שליליים', 'השוואה וסדר על הציר',
    'התלמיד ישווה שליליים על הציר', 'ביסוס סדר על ציר המספרים',
    'מספר שלילי גדול כי ספרתו גדולה', ['סדרו רשימה', 'מצאו בין שניים'],
    [fam('N7-08-compare', 'number_line_comparison', 'סדרו/השוו שליליים על הציר', 'ספרה גדולה=מספר גדול', ['השוואה'], ['שמאלה קטן יותר'], { requiredVisual: true })]);
  fb('N7-09', 'מספר נגדי וערך מוחלט בהקשר', 'נגדי וערך מוחלט',
    'התלמיד יבין נגדי וערך מוחלט בהקשר', 'ביסוס מושג הנגדי והערך המוחלט',
    'ערך מוחלט שלילי', ['מצאו נגדי', 'חשבו ערך מוחלט'],
    [fam('N7-09-abs', 'opposite_absolute_context', 'נגדי/ערך מוחלט בהקשר מציאותי', 'ערך מוחלט שלילי', ['הקשר'], ['ערך מוחלט אי-שלילי'], {})]);
  fb('N7-10', 'טעויות בחיבור וחיסור מכוונים', 'ניתוח טעות סימן',
    'התלמיד יאתר טעות בחיבור/חיסור מכוונים', 'חידוד טעויות סימן',
    'סימן לפי ספרה גדולה', ['מצאו טעות', 'תקנו פתרון'],
    [fam('N7-10-mistake', 'directed_add_sub_mistake', 'מצאו טעות בחיבור/חיסור מכוון', 'סימן שגוי', ['ניתוח טעות'], ['סימן לפי הרחוק מאפס'], {})]);
  fb('N7-11', 'חיבור וחיסור מכוונים בהקשר', 'יישום בהקשר',
    'התלמיד ייישם חיבור/חיסור מכוונים בהקשר', 'חיבור מכוונים למצב מציאותי',
    'התעלמות מכיוון', ['טמפרטורה', 'גובה/עומק'],
    [fam('N7-11-context', 'directed_add_sub_context', 'בעיית הקשר בחיבור/חיסור מכוון', 'התעלמות מכיוון', ['הקשר'], ['כיוון=סימן'], {})]);
  fb('N7-12', 'טעויות בכפל וחילוק מכוונים', 'ניתוח טעות סימן',
    'התלמיד יאתר טעות בכפל/חילוק מכוונים', 'חידוד כללי הסימנים',
    'החלת כלל החיבור על כפל', ['מצאו טעות', 'תקנו'],
    [fam('N7-12-mistake', 'directed_mul_div_mistake', 'מצאו טעות בכפל/חילוק מכוון', 'כלל סימן שגוי', ['ניתוח טעות'], ['סימנים זהים→חיובי'], {})]);
  fb('N7-13', 'כללי סימנים בכפל וחילוק', 'כללי סימנים',
    'התלמיד ייישם כללי סימנים בכפל וחילוק', 'ביסוס כללי הסימנים',
    'בלבול עם כללי החיבור', ['כפל', 'חילוק'],
    [fam('N7-13-rules', 'directed_mul_div_rules', 'יישום כללי סימנים', 'בלבול כללים', ['כפל/חילוק'], ['שונים→שלילי'], {})]);
  fb('U7-05', 'דיאגרמת עוגה ושכיחות יחסית', 'זווית מרכזית מאחוז',
    'התלמיד יחשב זווית מרכזית ויקרא דיאגרמת עוגה', 'חיבור אחוז לזווית מרכזית',
    'אחוז כמעלות / כפל ב-100', ['חשבו זווית מרכזית', 'מצאו אחוז חסר'],
    [fam('U7-05-pie', 'pie_chart_central_angle', 'זווית מרכזית מאחוז (×3.6°)', 'אחוז=מעלות', ['גזרה', 'אחוז חסר'], ['זווית=אחוז×360°'], { requiredVisual: true })]);
  fb('U7-06', 'תרשים מטעה — ביקורת', 'ביקורת ייצוג גרפי',
    'התלמיד יזהה מדוע תרשים מטעה ויציע תיקון', 'פיתוח קריאה ביקורתית של גרפים',
    'הסקה לפי גובה עמודה בלי לבדוק ציר', ['מדוע מטעה?', 'הציעו תיקון'],
    [fam('U7-06-misleading', 'misleading_graph_critique', 'מדוע התרשים מטעה? הציעו תיקון', 'התעלמות מציר y קטוע', ['ציר קטוע'], ['ציר y מתחיל ב-0'], { requiredVisual: true })]);
  fb('U7-07', 'טבלת שכיחויות ושכיחות יחסית', 'ארגון נתונים',
    'התלמיד יארגן נתונים בטבלה ויחשב שכיחות יחסית', 'ביסוס טבלת תדירות',
    'תדירות יחסית כספירה', ['ארגנו טבלה', 'חשבו תדירות יחסית'],
    [fam('U7-07-table', 'frequency_table_relative', 'בנו טבלה וחשבו שכיחות יחסית', 'תדירות יחסית=ספירה', ['טבלה'], ['ספירה חלקי סך'], { requiredVisual: true })]);
  fb('U7-08', 'ממוצע חציון וטווח', 'מדדי מרכז ופיזור',
    'התלמיד יחשב ממוצע, חציון וטווח', 'ביסוס מדדים סטטיסטיים',
    'חציון בלי מיון', ['חשבו ממוצע', 'מצאו חציון'],
    [fam('U7-08-stats', 'mean_median_range', 'חשבו ממוצע/חציון/טווח', 'חציון בלי מיון', ['מדדים'], ['מיון לפני חציון'], {})]);
  fb('G7-05', 'הזזות שיקופים וסיבובים', 'טרנספורמציות במישור',
    'התלמיד יזהה תוצאת הזזה/שיקוף/סיבוב', 'ביסוס טרנספורמציות בסיסיות',
    'בלבול בין סוגי הטרנספורמציה', ['הזזה', 'שיקוף'],
    [fam('G7-05-transform', 'transformations', 'מצאו תמונת נקודה/צורה לאחר טרנספורמציה', 'בלבול סוג טרנספורמציה', ['הזזה/שיקוף/סיבוב'], ['שמירת מרחקים'], { requiredVisual: true })]);
  fb('G7-06', 'שטח צורה מורכבת', 'פירוק לצורות',
    'התלמיד יחשב שטח צורה מורכבת בפירוק', 'ביסוס פירוק שטחים',
    'שכחת חלק/כפל שגוי', ['פרקו לצורות', 'חברו שטחים'],
    [fam('G7-06-composite', 'composite_area', 'שטח צורה מורכבת בפירוק', 'שכחת תת-צורה', ['פירוק'], ['חיבור/חיסור שטחים'], { requiredVisual: true })]);
  fb('G8-05', 'זווית מרכזית וחלק מעיגול', 'זווית מרכזית וגזרה',
    'התלמיד יחשב זווית מרכזית וחלק מעיגול', 'חיבור זווית מרכזית לחלק מהעיגול',
    'בלבול זווית מרכזית עם היקפית', ['זווית מרכזית', 'שטח גזרה'],
    [fam('G8-05-sector', 'central_angle_sector', 'זווית מרכזית/גזרה מתוך עיגול', 'מרכזית כהיקפית', ['גזרה'], ['חלק=זווית/360'], { requiredVisual: true })]);
  fb('G8-06', 'קוטר רדיוס ומיתר', 'יסודות העיגול',
    'התלמיד יבחין בין קוטר, רדיוס ומיתר', 'ביסוס מושגי העיגול',
    'בלבול מיתר עם קוטר', ['זהו קוטר/רדיוס', 'מיתר ארוך ביותר'],
    [fam('G8-06-parts', 'diameter_radius_chord', 'זיהוי קוטר/רדיוס/מיתר', 'מיתר=קוטר', ['חלקי עיגול'], ['קוטר=מיתר דרך המרכז'], { requiredVisual: true })]);
  fb('G8-07', 'חפיפת משולשים לפי סימונים', 'משפטי חפיפה',
    'התלמיד יזהה חפיפה לפי סימונים', 'ביסוס משפטי חפיפה',
    'הנחת חפיפה מסימון חלקי', ['זהו משפט חפיפה', 'השלימו נתון'],
    [fam('G8-07-congruence', 'triangle_congruence_markings', 'זיהוי חפיפה לפי סימונים', 'חפיפה מנתון חלקי', ['צ.צ.צ/צ.ז.צ/ז.צ.ז'], ['התאמת סימונים'], { requiredVisual: true })]);
  fb('G8-08', 'משולש שווה שוקיים', 'תכונות שווה-שוקיים',
    'התלמיד יישם תכונות משולש שווה-שוקיים', 'ביסוס תכונות שווה-שוקיים',
    'הנחת שוויון זוויות בסיס בלי נימוק', ['זוויות בסיס', 'שוק/בסיס'],
    [fam('G8-08-isosceles', 'isosceles_triangle', 'תכונות שווה-שוקיים', 'זוויות בסיס שונות', ['שוקיים', 'זוויות בסיס'], ['זוויות הבסיס שוות'], { requiredVisual: true })]);
  fb('G8-09', 'דמיון וצללים', 'דמיון ביישום צללים',
    'התלמיד ייישם דמיון בבעיות צל', 'יישום דמיון משולשים בהקשר',
    'התעלמות מיחס הדמיון', ['גובה מצל', 'יחס דמיון'],
    [fam('G8-09-shadows', 'similarity_and_shadows', 'גובה עצם מצל לפי דמיון', 'התעלמות מיחס', ['צללים'], ['יחס דמיון זהה'], { requiredVisual: true })]);
})();
