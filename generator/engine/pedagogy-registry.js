...
(function () {
  ...
  topic('A7-01-ENGINE', {
    ...
    families: [
      ...
      fam('A7-01-rect', 'rectangle_expression', 'היקף/שטח מלבן עם צלע פי k', 'בלבול היקף/שטח בביטוי', ['היקף', 'שטח'], ['שטח=מכפלה'], { requiredVisual: true }),
      ...
      fam('A7-01-tower', 'tower_general_term', 'גובה מגדל n כוסות', 'התעלמות מ-(n−1) התוספות', ['גובה התחלתי+תוספת'], ['ביטוי תקף גם ל-n=1'], { requiredVisual: true }),
      ...
      fam('A7-01-poly', 'polygon_perimeter_expression', 'ביטוי להיקף מצולע עם צלעות אלגבריות', 'אי-כינוס המספרים החופשיים', ['משולש', 'מרובע'], ['היקף=סכום הצלעות מפושט'], { requiredVisual: true, answerFormat: 'ביטוי היקף מפושט + ערך בהצבה' })
    ]
  });
  topic('A7-02-ENGINE', {
