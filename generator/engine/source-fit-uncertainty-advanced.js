...
(function(){
  ...
  function pieSvg(data,title){
    ...
    return `<svg class="engine-svg" viewBox="0 0 292 205" xmlns="http://www.w3.org/2000/svg"><rect x="14" y="12" width="264" height="178" rx="14" fill="${T.fill}" stroke="${T.stroke}" stroke-width="1.8"/><text x="146" y="32" font-size="12" font-weight="900" text-anchor="middle" fill="${T.label}">${title}</text>${slices}<circle cx="86" cy="90" r="52" fill="none" stroke="${T.stroke}" stroke-width="2"/>${legend}<text x="146" y="181" font-size="11" font-weight="800" fill="${T.label}" text-anchor="middle">דיאגרמת עוגה</text></svg>`;
  }
